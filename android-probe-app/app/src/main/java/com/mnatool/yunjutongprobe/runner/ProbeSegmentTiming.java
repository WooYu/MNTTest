 ...
 */
public class ProbeSegmentTiming {
    ...
    public static void applyEchoTimestamps(ProbeSample sample, JSONObject ack, long clientRecvMs) {
    ...
    public static String formatInboundLog(long clientSendNs, long clientSendMs, long recvNs, long recvMs) {
    ...
    public static String formatEchoRttLog(int seq, ProbeSample sample, double rttMs) {
    ...
    private static final class Segment {
        ...
        final double echoMs;
        final double retMs;
        public final boolean wallClock;
        public final boolean trusted;

    public Segment(double outMs, double echoMs, double retMs, boolean wallClock, boolean trusted) {
            this.outMs = outMs;
            this.echoMs = echoMs;
            this.retMs = retMs;
