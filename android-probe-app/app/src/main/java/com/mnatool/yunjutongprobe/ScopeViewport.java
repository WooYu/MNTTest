...
final class ScopeViewport {
    ...
    void setFollowAnchorSeq(int seq) {
    ...
    /** 以视口内焦点 seq 为锚点捏合缩放。 */
    void zoomAt(float focusX, float scaleFactor) {
