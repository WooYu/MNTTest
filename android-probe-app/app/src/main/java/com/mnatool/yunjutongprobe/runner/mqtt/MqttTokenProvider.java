...
public class MqttTokenProvider {
    ...
    public static String usernameForEnv(String env) {
    return baseDomain(env) + "/api";
    }

    public static String getToken(String env, String sn, String pwd, String mac) throws Exception {
