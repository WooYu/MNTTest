 ...
 */
public class ProbePerfStats {
    public final int targetPps;
    ...
    public ProbePerfStats(int targetPps) {
    ...
    public void beforeSend(long sendNs, long scheduledNs) {
        if (startNs < 0) {
            startNs = sendNs;
        }
    ...
    public void markEnd(long nowNs) {
        endNs = nowNs;
    }
    ...
    public long maxSendLagMs() {
        return maxLagNs / ProbeConstants.Units.NS_PER_MS;
    }

    public int sendBehindCount() {
        return behindCount;
    }
