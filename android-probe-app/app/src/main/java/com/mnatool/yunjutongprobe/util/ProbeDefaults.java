...
public class ProbeDefaults {
    public static final String PREFERENCE_VERSION_KEY = "probeDefaultsVersion";
    ...
    LAB("实验室十万级", "100000", "2000", "100", "60000");
        ...
        public final String pps;
        public final String packetBytes;
        public final String timeoutMs;
    ...
    public static Preset detectPreset(String count, String pps, String packetBytes, String timeoutMs) {
    ...
    public static boolean isHighPpsRun(int count, int pps) {
    ...
    public static boolean recordEchoSeqForConfig(int count, int pps, int packetBytes, int timeoutMs) {
        return !isHighPpsRun(count, pps);
    }

    /** 首屏预填档位：现场千级（时长短、最常用）。如需默认十万级改为 Preset.LAB。 */
    public static final Preset DEFAULT_PRESET = Preset.FIELD;

    public static final String COUNT = DEFAULT_PRESET.count;
    public static final String PPS = DEFAULT_PRESET.pps;
    public static final String PACKET_BYTES = DEFAULT_PRESET.packetBytes;
    public static final String TIMEOUT_MS = DEFAULT_PRESET.timeoutMs;
    ...
    public static void migrateIfNeeded(SharedPreferences prefs) {
