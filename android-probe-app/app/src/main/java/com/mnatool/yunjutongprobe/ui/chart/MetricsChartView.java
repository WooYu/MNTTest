...
public final class MetricsChartView extends ScopeChartView {
    public static final int LEFT_PAD_DP = 10;
    public static final int RIGHT_PAD_DP = 12;
    public static final int SPACING_DP = 7;
    public static final int BAR_WIDTH_DP = 5;
